    ...
    <div class="content add-padding">
      <div class="header-content">
        ...
        <div class="number text-center text-bold">
          <countTo separator="" :startVal='0' :endVal='goodsManage.totalMerchantSales' :duration='1500'></countTo>
        </div>
        <div class="add-number text-center">
          <div class="add-img">
            <img src="../../assets/img/add-nomber.png" alt="今日新增" />
          </div>
          <div class="today-number text-bold text-break">今日下降 - {{ goodsManage.totalMerchantSalesDaily }}</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    goSalesVolume() {
      this.$router.push({ path: 'sales-volume' })
    }
  },
  mounted() {
    this.getGoodsManage()
